...
- Knowledge Validation v1 is prepared and is now at its deliberate human gate. The private deterministic packet inventories all 102 review-only website candidates and selects 48 stratified semantic cases (activities 14, beneficiaries 16, geography 10, participation 6, programs 2), including boilerplate/rhetoric and key boundary traps. No case is published or treated as gold. Opportunities, self-description, fundraising and identity-sensitive web observations have no candidate evidence and are NOT READY; observed domains remain HUMAN REVIEW. `KNOWLEDGE_VALIDATION_HUMAN_GATE.md` is the compact 20–30 minute decision script; `CONSUMER_LLM_EVALUATION.md` now provides criteria for every one of the 16 prompts. No naïve consumer-product result or model proxy result has been claimed.
