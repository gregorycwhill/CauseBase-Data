...
- The Viewer v0.5 gate is also green: its generated browser index is derived directly from the selected Data release, all Viewer tests pass and all 228 source-record links resolve in the static bundle. The pending operational action is commit/push, then invoke the Pages workflow; it explicitly checks out CauseBase Data and selects `v0.5.0-2026-08-15`.
