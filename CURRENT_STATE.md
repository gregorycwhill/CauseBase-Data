...
- Golden Corpus v1 is established (21 governed cases; seven hard-gold and fourteen review-required). The first document-stack benchmark conditionally adopts Document Pipeline v2: `pdfplumber` native text/positioned blocks/tables are the private baseline; OCR and visual routes remain explicit, unavailable/unconfigured where no engine is present. See GOLDEN_CORPUS.md and DOCUMENT_EXTRACTION_STACK_DECISION.md. No new public release or corpus enrichment is authorised in this increment.
